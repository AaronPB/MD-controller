...
class ConfigPaths(Enum):
    ...
    MQTT_TOPIC_P1_MANUAL = "mqtt_topics.pump_1_manual"
    MQTT_TOPIC_P2_MANUAL = "mqtt_topics.pump_2_manual"
    MQTT_TOPIC_P1_MANUAL_OP = "mqtt_topics.pump_1_manual_op"
    MQTT_TOPIC_P2_MANUAL_OP = "mqtt_topics.pump_2_manual_op"
